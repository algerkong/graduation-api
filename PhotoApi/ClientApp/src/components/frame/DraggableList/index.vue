...
export default class extends Vue {
    @Prop({ default: () => [] })
    private list1!: IArticleData[];
    @Prop({ default: () => [] })
    private list2!: IArticleData[];
    @Prop({ default: "list1" })
    private list1Title!: string;
    @Prop({ default: "list2" })
    private list2Title!: string;
    @Prop({ default: "48%" })
    private list1width!: string;
    @Prop({ default: "48%" })
    private list2width!: string;
